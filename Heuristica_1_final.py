...
while len(lista_items_scores) > 0:
    ...
    # Atualizando lista de scores, tirando o primeiro valor
    lista_items_scores = lista_items_scores[1:]
...
### Início da fase 2: consumir recursos restantes até a capacidade máxima de cada item i, produzindo o que der com o restante ###
